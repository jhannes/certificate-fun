...
public class CertificateAuthority {
    ...
    public CertificateAuthority(KeyStoreFile keyStoreFile, Period validity) {
        this(keyStoreFile.getKeyStore(), validity);
    }

    public CertificateAuthority(SingleKeyStore keyStore, Period validity) {
    ...
    X509Certificate issueServerCertificate(String hostname, String subject, ZonedDateTime validFrom, PublicKey publicKey) throws IOException, CertificateException, KeyStoreException, NoSuchAlgorithmException, InvalidKeyException, NoSuchProviderException, SignatureException, UnrecoverableKeyException {
        CertificateExtensions extensions = new CertificateExtensions();
